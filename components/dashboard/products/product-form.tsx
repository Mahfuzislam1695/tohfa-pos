...
export function ProductForm({ editItem, onSuccess, onCancel }: ProductFormProps) {
  ...
  //       productName: productNameForPrint,
  ...
  // <html>
  // <head>
  //   <title>Print Barcodes - ${productNameForPrint}</title>
  ...
  //         <div class="product-name">${productNameForPrint}</div>
  //         <div class="product-sku">SKU: ${productSkuForPrint}</div>
